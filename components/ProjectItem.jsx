...
const ProjectItem = ({title, image, url, descr}) => {
  return (
    <div className='relative flex items-center justify-center h-[390px] w-full shadow-md shadow-gray-800 rounded-sm p-1 group hover:bg-gray-800 overflow-hidden'>
    <Image 
