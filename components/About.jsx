      ...
      <Head>
        ...
        <div className='max-w-[1200px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='text-sm font-medium'>Welcome to my website portfolio! I&apos;m an engineering student at the University of Waterloo, interested in software development. I have experience in Artificial Intelligence and all things autonomous robotics. Additionally, I&apos;m working software integration and embedded systems in robotic development.</p>
            ...
            <div className='w-full h-auto m-auto rounded-md items-center justify-center fill border-solid border-4 border-black'>
                <Image 
                src={profPic} 
                alt='/' 
                width={400} 
